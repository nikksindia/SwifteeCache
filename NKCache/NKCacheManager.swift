...
final public class NKCacheManager {
  ...
  /// Singleton instance
  public static var sharedInstance = NKCacheManager.init(cacheName: Bundle.main.infoDictionary?["TargetName"] as? String ?? "AppCache")
