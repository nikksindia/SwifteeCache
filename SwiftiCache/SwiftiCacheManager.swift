...
final public class SwiftiCacheManager {
  ...
  /// Singleton instance
  public static var sharedInstance = SwiftiCacheManager.init(cacheName: Bundle.main.infoDictionary?["TargetName"] as? String ?? "AppCache")
